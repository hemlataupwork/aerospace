...
class image_list extends table_sql {
    ...
    //     global $CFG;
    //     $button_html = "<a href='$CFG->wwwroot/local/media/delete_lab_image.php?id=$values->id' class='btn btn-primary'><i class='fa fa-trash'></i></a>";
    //     return $button_html;
    // }
...
function deleteImage(imageid) {
    if (confirm('Are you sure you want to delete this record?')) {
        ...
        xhr.open('POST', '<?php echo $CFG->wwwroot; ?>/local/media/delete_lab_image.php', true);
