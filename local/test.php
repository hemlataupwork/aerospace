...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $id = required_param('cohortid', PARAM_INT);
...
$cohorts = $DB->get_records_sql('SELECT * FROM {cohort}');
    // var_dump($cohorts);die;
...
$context = context::instance_by_id($cohort->id, MUST_EXIST);
